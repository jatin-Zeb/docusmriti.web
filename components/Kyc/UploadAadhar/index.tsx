...
const UploadAadhar: React.FC<UploadAadharProps> = ({
  step,
  setStep,
  aadhar,
  setAadhar,
  ...
  const [front, frontType] = aadhar.front.length
    ? aadhar.front[0].type.split("/")
    : ["", ""];
  const [back, backType] = aadhar.back.length
    ? aadhar.back[0].type.split("/")
    : ["", ""];
    ...
    <div>
      ...
      <div>
        ...
        <div css={styles.container}>
          {frontUrl.length && aadhar.front.length ? (
            <div css={styles.file}>
          ...
          {backUrl.length && aadhar.back.length ? (
            <div css={styles.file}>
      ...
      <div css={styles.buttonContainer}>
        ...
        <Button
          type="blue"
          onClick={() => setStep(step + 1)}
          disabled={!aadhar.front.length || !aadhar.back.length}
        >
          Next
        </Button>
      </div>
