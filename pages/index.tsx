            ...
            <div css={styles.main}>
              <div css={utils.widthPercentage(60)}>
                <div css={styles.heading}>
                  <p
                    css={{
                      color: colors.Docu_Solid_Text_Purple,
                      marginBottom: "0px",
                    }}
                  >
                    Verify your Doc
                  </p>
                  <p css={{ margin: "0px" }}>On The Block</p>
                </div>
                <p css={styles.subHeading}>
                  Securely store, access and share documents effortlessly on the
                  Ethereum Blockchain.
                </p>
              ...
              <div css={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div css={{ width: "30%" }}>
                  ...
                  <p css={styles.featureSubHeading}>
                    ...
                    preservation of your important files, while also allowing
              ...
              >
                <div css={{ width: "30%" }}>
                  ...
                  <ul css={styles.ul}>
                    ...
                    <li>
                      Provides a tamper-proof and auditable record of all
                      document changes
                    </li>
                    <li>
                ...
                <div css={{ width: "30%" }}>
                  ...
                  <ul css={styles.ul}>
                    <li>
                      Unmatched security: Our Blockchain powered website
                      provides the highest level of security for your documents,
                      ensuring that they are tamper-proof and can never be lost
                      or stolen.
                    </li>
                  </ul>
                </div>
